...
,
  ...
  return (
    <Grid container height ={"100%"} width={"100%"} p={4} flexDirection={"row"} >
      <Grid item container flexDirection={"column"} sm={12} borderRadius={4} border={"1px solid"}  borderColor={"grey.300"}>
          <Grid item container flexDirection={"row"} sm={2}  minWidth={"70%"} display={"flex"} alignItems={"center"} px={2}>
            <Grid item sm={6} >
              <TextField 
                InputProps=
                {{
          ...
          <Grid item sm={10} borderRadius={4} px={2} pb={2} minWidth={"100%"}>
              <DataGrid
              sx={{
