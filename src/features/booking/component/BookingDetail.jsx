      ...
      <Table size='small'>
        <TableBody>
          ...
          <TableRow>
            ...
            <TableCell variant='head' align='right'sx={{padding:"16px 0px"}}>{data.timeSubmit.$d.toString()}</TableCell>
          </TableRow>
          <TableRow>
              <TableCell component="th" scope="row"sx={{padding:"16px 0px"}}>
            ...
            <TableRow>
              ...
              <IconButton sx={{pointerEvents: 'none' , color: red[700],}}><MdLocationOn/></IconButton>
                Điểm đến</TableCell>
              <TableCell variant='head' align='right'sx={{padding:"16px 0px"}}>{data.endLocation}</TableCell>
            </TableRow>
            <TableRow>
              <TableCell component="th" scope="row"sx={{padding:"16px 0px"}}>
            ...
            <TableRow>
              ...
              <IconButton sx={{pointerEvents: 'none', color: yellow[700]}}><MdOutlineAttachMoney/></IconButton>
                Tổng tiền</TableCell>
              <TableCell variant='head' align='right'sx={{padding:"16px 0px"}}>{data.payment}</TableCell>
            </TableRow>
        </TableBody>
      </Table>
    </TableContainer>
